...
app.post('/api/qrcode', upload.single('qrCode'), (req, res) => {
    const file = req.file;
    if (!file) {
...
// New endpoint to get the QR code image
app.get('/api/qrcode', (req, res) => {
    const qrCodePath = path.join(QR_CODE_PATH, 'qrcode.png'); // Path to the QR code image
